...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button_a.setGeometry(QRect(590, 700, 71, 60))
        self.button_b = QPushButton(self.centralwidget)
        self.button_b.setObjectName(u"button_b")
        self.button_b.setGeometry(QRect(670, 700, 71, 60))
        self.gBox_methods = QGroupBox(self.centralwidget)
        self.gBox_methods.setObjectName(u"gBox_methods")
        self.gBox_methods.setGeometry(QRect(630, 30, 200, 431))
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.gBox_methods.sizePolicy().hasHeightForWidth())
        self.gBox_methods.setSizePolicy(sizePolicy)
        self.button_hidden_triple = QPushButton(self.gBox_methods)
        self.button_hidden_triple.setObjectName(u"button_hidden_triple")
        self.button_hidden_triple.setGeometry(QRect(10, 310, 180, 60))
        self.button_naked_triple = QPushButton(self.gBox_methods)
        self.button_naked_triple.setObjectName(u"button_naked_triple")
        self.button_naked_triple.setGeometry(QRect(10, 240, 180, 60))
        self.button_single = QPushButton(self.gBox_methods)
        self.button_single.setObjectName(u"button_single")
        self.button_single.setGeometry(QRect(10, 30, 180, 60))
        self.button_naked_pair = QPushButton(self.gBox_methods)
        self.button_naked_pair.setObjectName(u"button_naked_pair")
        self.button_naked_pair.setGeometry(QRect(10, 100, 180, 60))
        self.button_hidden_pair = QPushButton(self.gBox_methods)
        self.button_hidden_pair.setObjectName(u"button_hidden_pair")
        self.button_hidden_pair.setGeometry(QRect(10, 170, 180, 60))
        self.notes_box = QCheckBox(self.gBox_methods)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.gBox_methods.setTitle(QCoreApplication.translate("MainWindow", u"\u041f\u043e\u0448\u0430\u0433\u043e\u0432\u043e\u0435 \u0440\u0435\u0448\u0435\u043d\u0438\u0435", None))
